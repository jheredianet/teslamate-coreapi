...
namespace coreAPI.Models
{
    public partial class teslamateContext : DbContext
    {
        ...
        public virtual DbSet<Aux> Auxes { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.HasPostgresEnum("billing_type", new[] { "per_kwh", "per_minute" })
                ...
                .HasPostgresEnum("unit_of_pressure", new[] { "bar", "psi" })
            ...
            modelBuilder.Entity<Aux>(entity =>
            {
                entity.ToTable("aux");

                entity.Property(e => e.Id).HasColumnName("id");

                entity.Property(e => e.TimeToFullCharge).HasColumnName("time_to_full_charge");
            });
            ...
            modelBuilder.Entity<Position>(entity =>
            {
                ...
                entity.Property(e => e.TpmsPressureFl)
                    .HasPrecision(4, 1)
                    .HasColumnName("tpms_pressure_fl");

                entity.Property(e => e.TpmsPressureFr)
                    .HasPrecision(4, 1)
                    .HasColumnName("tpms_pressure_fr");

                entity.Property(e => e.TpmsPressureRl)
                    .HasPrecision(4, 1)
                    .HasColumnName("tpms_pressure_rl");

                entity.Property(e => e.TpmsPressureRr)
                    .HasPrecision(4, 1)
                    .HasColumnName("tpms_pressure_rr");
